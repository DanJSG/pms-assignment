%EARLYREFLECTIONS Adds early reflections to signal
...
%
% Realistic presets can be made using the online tool below:
% https://amcoustics.com/tools/amray
%
% DTM, 6/11/2018
% Last Modified: Y3846756, 23/12/2020
%
% Input Variables:
%   in : input signal
%   buffer : the buffer containing the previous and future signal values
%   n : number of samples
%   delays: 2D matrix containing delay times and associated gains
