...
clipLength = floor(crotchetDuration * 8);
...
chord(3 * length(note4): 3 * length(note4) + length(note7) - 1) = note7 + note8;
chord(3 * length(note4) + length(note7): 3 * length(note4) + (2 * length(note7)) - 1) = note9 + note10;
